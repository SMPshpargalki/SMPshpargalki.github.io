...
const gcsData = [
    {
        ...
        options: [
            { text: "Произвольное", score: 4 },
            { text: "На речевую команду", score: 3 },
            { text: "На болевое раздражение", score: 2 },
            { text: "Отсутствует", score: 1 }
        ]
    },
    {
        label: "Наилучший речевой ответ",
        options: [
            { text: "Ориентирован и контактен", score: 5 },
            { text: "Бессвязная речь, спутанность", score: 4 },
            { text: "Отдельные слова", score: 3 },
            { text: "Нечленораздельные звуки", score: 2 },
            { text: "Отсутствует", score: 1 }
        ]
    },
    {
        label: "Наилучший двигательный ответ",
        options: [
            { text: "Выполнение команды", score: 6 },
            { text: "Локализация боли", score: 5 },
            { text: "Отдёргивание конечности на боль", score: 4 },
            { text: "Патологическое сгибание", score: 3 },
            { text: "Патологическое разгибание", score: 2 },
            { text: "Нет ответа", score: 1 }
        ]
    }
];
