const shoxData = [
  ...
  {label:"В каком положении находится в постели", options:[{text:"горизонтальном", value:0},{text:"с приподнятым головным концом (2+ подушки)", value:1},{text:"с приподнятым головным концом (2+ подушки) плюс просыпается от удушья", value:2},{text:"сидя", value:3}]},
  {label:"Набухшие шейные вены", options:[{text:"нет", value:0},{text:"лежа", value:1},{text:"стоя", value:2}]},
  {label:"Хрипы в легких", options:[{text:"Нет", value:0},{text:"нижние отделы (до 1/3)", value:1},{text:"до лопаток (до 2/3)", value:2},{text:"над всей поверхностью легких", value:3}]},
  {label:"Наличие ритма галопа", options:[{text:"нет", value:0},{text:"есть", value:1}]},
  {label:"Печень", options:[{text:"не увеличена", value:0},{text:"увеличена до 5 см", value:1},{text:"увеличена более 5 см", value:2}]},
  {label:"Отеки", options:[{text:"нет", value:0},{text:"пастозность", value:1},{text:"отеки", value:2},{text:"анасарка", value:3}]},
  {label:"Уровень САД", options:[{text:">120", value:0},{text:"100–120", value:1},{text:"<100", value:2}]}];
