const burnData = {
  "adult": { 
    "head_front":3.5,"head_back":3.5,"neck_front":1,"neck_back":1,
    "chest_front":9,"chest_back":9,"abdomen":9,"back":5,
    "r_shoulder_front":2,"r_shoulder_back":2,"l_shoulder_front":2,"l_shoulder_back":2,
    "r_forearm_front":2,"r_forearm_back":2,"l_forearm_front":2,"l_forearm_back":2,
    "r_hand_front":1,"r_hand_back":1,"l_hand_front":1,"l_hand_back":1,
    "r_thigh_front":4,"r_thigh_back":4,"l_thigh_front":4,"l_thigh_back":4,
    "r_calf_front":3.5,"r_calf_back":3.5,"l_calf_front":3.5,"l_calf_back":3.5,
    "r_foot":3,"l_foot":3,"right_butt":2,"left_butt":2,"perineum":1
  }
};
...
function renderBurnSVG(){
  ...
  const shapes = currentView==="front"?[
    ...
    {id:"chest_front", type:"rect", x:110, y:105, w:80, h:60, rx:15, ry:15},
    {id:"abdomen", type:"rect", x:110, y:170, w:80, h:60, rx:15, ry:15},
    {id:"r_shoulder_front", type:"rect", x:195, y:130, w:25, h:60, rx:12, ry:12},
    {id:"l_shoulder_front", type:"rect", x:80, y:130, w:25, h:60, rx:12, ry:12},
    ...
    {id:"r_thigh_front", type:"rect", x:120, y:240, w:35, h:80, rx:15, ry:15},
    {id:"l_thigh_front", type:"rect", x:145, y:240, w:35, h:80, rx:15, ry:15},
    {id:"r_calf_front", type:"rect", x:120, y:320, w:35, h:80, rx:15, ry:15},
    {id:"l_calf_front", type:"rect", x:145, y:320, w:35, h:80, rx:15, ry:15},
    {id:"r_foot", type:"ellipse", cx:137, cy:400, rx:15, ry:10},
    {id:"l_foot", type:"ellipse", cx:163, cy:400, rx:15, ry:10},
    ...
    {id:"chest_back", type:"rect", x:110, y:105, w:80, h:60, rx:15, ry:15},
    {id:"back", type:"rect", x:110, y:170, w:80, h:60, rx:15, ry:15},
    {id:"r_shoulder_back", type:"rect", x:195, y:130, w:25, h:60, rx:12, ry:12},
    {id:"l_shoulder_back", type:"rect", x:80, y:130, w:25, h:60, rx:12, ry:12},
    ...
    {id:"r_thigh_back", type:"rect", x:120, y:240, w:35, h:80, rx:15, ry:15},
    {id:"l_thigh_back", type:"rect", x:145, y:240, w:35, h:80, rx:15, ry:15},
    {id:"r_calf_back", type:"rect", x:120, y:320, w:35, h:80, rx:15, ry:15},
    {id:"l_calf_back", type:"rect", x:145, y:320, w:35, h:80, rx:15, ry:15},
    {id:"r_foot", type:"ellipse", cx:137, cy:400, rx:15, ry:10},
    {id:"l_foot", type:"ellipse", cx:163, cy:400, rx:15, ry:10},
