...
70:["Внутривенно 0.7мг-0.7мл"],}},
    ...
    АктивированныйУголь:{
        ...
        unit:"вес в кг",
        steps:[5,10,15,20,25,30,35,40,45,50,55,60,65,70],
        info:["<b>Название:</b>","Carbonis activati","<b>Дозировка:</b>","Таблетка-250мг","<b>Дозировка введения:</b>","50 мг/кг","<b>Метод введения:</b>","Перорально","<b>Ограничения:</b>","Возрастных ограничений нет."],
