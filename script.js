...
table:{
    5:["Внутривенно 0.05мг-0.05мл","Эндотрахеально 0.5мг-0.5мл"],
...
table:{
    ...
    Аминофиллин:{
name:"Аминофиллин",
synonyms:["Эуфиллин","euphyllin"],
type:"weight",
unit:"вес в кг",
steps:[5,10,15,20,25,30,35,40,45,50,55,60,65,70],
info:["<b>Название:</b>","Аминофиллин; Euphyllini","Ампула 24мг/мл – 10мл",
      "<b>Дозировка введения:</b>","Внутривенно 3 мг/кг или 0.13мл",
      "<b>Максимальная дозировка:</b>","Суточная - 15мг/кг",
      "<b>Ограничения:</b>","Возрастных ограничений нет"],
table:{
    5:["15мг-0.6мл"],
    10:["30мг-1.3мл"],
    ...
    Амиодарон:{
name:"Амиодарон",
synonyms:["кордарон","Amiodaron"],
type:"weight",
unit:"вес в кг",
steps:[5,10,15,20,25,30,35,40,45,50,55,60,65,70],
info:["<b>Название:</b>","Амиодарон; Amiodaron","Ампула 50мг/мл – 3мл",
...
table:{
    ...
    Дмазепам:{
        ...
        info:["<b>Название:</b>","Diazepami; Relanii; Sibazoni",
              "<b>Дозировка:</b>","5мг/мл - 2мл",
              "<b>Дозировка введения:</b>","0,2-0,5 мг/кг - в/венно","0,5 мг/кг - в/мышечно",
              "<b>Максимальная разовая доза:</b>","до 5 лет - 5мг","старше 5 лет - 10мг",
              "<b>Метод введения:</b>","В/в медленно не менее 2х минут.","Повторное введение через 5-15 минут, в разовой дозе.",
              "<b>Ограничения:</b>","Возрастных ограничений нет."],
        table:{
            5:["от 1мг-0.2мл","до 2.5мг-0.5мл"],
