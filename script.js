...
const DRUGS = {
    Адреналин:{
name:"Адреналин",synonyms:["эпинефрин","epinephrin","adrenalin"],type:"weight",unit:"вес в кг",steps:[5,10,15,20,25,30,35,40,45,50,55,60,65,70],info:["<b>Название:</b>","Эпинефрин; Adrenalini","<b>Дозировка:</b>","Ампула 1мг/мл - 1мл","<b>Дозировка введения:</b>","0.01мг/кг - внутривенно","0.1мг/кг - эндотрахеально","<b>Метод введения:</b>","Внутривенно; Эндотрахеально","<b>Ограничения:</b>","Возрастных ограничений нет"],
table:{5:["Внутривенно 0.05 мг - 0.05мл","Эндотрахеально 0.5мг - 0.5мл"],10:["Внутривенно 0.1мг - 0.1мл","Эндотрахеально 1мг - 1мл"],15:["Внутривенно 0.15мг - 0.15мл","Эндотрахеально 1.5мг - 1.5мл"],20:["Внутривенно 0.2 мг - 0.2мл","Эндотрахеально 2мг - 2мл"],25:["Внутривенно 0.25 мг - 0.25мл"],30:["Внутривенно 0.3мг - 0.3мл"],35:["Внутривенно 0.35мг - 0.35мл"],40:["Внутривенно 0.4мг - 0.4мл"],45:["Внутривенно 0.45мг - 0.45мл"],50:["Внутривенно 0.5мг - 0.5мл"],55:["Внутривенно 0.55мг - 0.55мл"],60:["Внутривенно 0.6мг - 0.6мл"],65:["Внутривенно 0.65мг - 0.65мл"],70:["Внутривенно 0.7мг - 0.7мл"],}},

    АктивированныйУголь:{
name:"Активированный уголь",synonyms:["уголь"],type:"weight",unit:"вес в кг",steps:[5,10,15,20,25,30,35,40,45,50,55,60,65,70],info:["<b>Название:</b>","Carbonis activati","<b>Дозировка:</b>","Таблетка-250мг","<b>Дозировка введения:</b>","50 мг/кг","<b>Метод введения:</b>","Перорально","<b>Ограничения:</b>","Возрастных ограничений нет."],
table:{5:["1 таблетка - 250мг"],10:["2 таблетки - 500мг"],15:["3 таблетки - 750мг"],20:["4 таблетки - 1000мг"],25:["5 таблеток - 1250мг"],30:["6 таблеток - 1500мг"],35:["7 таблеток - 1750мг"],40:["8 таблеток - 2000мг"],45:["9 таблеток - 2250мг"],50:["10 таблеток - 2500мг"],55:["11 таблеток - 2750мг"],60:["12 таблеток - 3000мг"],65:["13 таблеток - 3250мг"],70:["14 таблеток - 3500мг"],}},
    ...
    Аминофиллин:{
name:"Аминофиллин",synonyms:["Эуфиллин","euphyllin"],type:"weight",unit:"вес в кг",steps:[5,10,15,20,25,30,35,40,45,50,55,60,65,70],info:["<b>Название:</b>","Аминофиллин; Euphyllini","<b>Дозировка:</b>","Ампула 24мг/мл – 10мл","<b>Дозировка введения:</b>","4-5 мг/кг","<b>Метод введения:</b>","Внутривенно","<b>Ограничения:</b>","Возрастных ограничений нет"],
table:{5:["От 20мг-0.8мл до 25мг-1мл"],10:["От 40мг-1.6мл до 50мг-2мл"],15:["От 60мг-2.5мл до 75мг-3.1мл"],20:["От 80мг-3.3мл до 100мг-4.1мл"],25:["От 100мг-4.1мл до 125мг-5.2мл"],30:["От 120мг-5мл до 150мг-6.2мл"],35:["От 140мг-5.8мл до 175мг-7.3мл"],40:["От 160мг-6.6мл до 200мг-8.3мл"],45:["От 180мг-7.5мл до 225мг-9.3мл"],50:["От 200мг-8.3мл до 240мг-10мл"],55:["От 220мг-9.1мл до 240мг-10мл"],60:["240мг-10мл"],65:["240мг-10мл"],70:["240мг-10мл"],}},

    Амиодарон:{
name:"Амиодарон",synonyms:["кордарон","Amiodaron"],type:"weight",unit:"вес в кг",steps:[5,10,15,20,25,30,35,40,45,50,55,60,65,70],
info:[
"<b>Название:</b>","Амиодарон; Amiodaron","Ампула 50мг/мл – 3мл",
"<b>Дозировка введения:</b>","Внутривенно 5мг/кг или 0.1мл/кг",
"<b>Максимальная дозировка:</b>","Разовая – не более 300мг","Суточная – 600мг"],
"<b>Ограничения:</b>","Возрастных ограничений нет"],
table:{
5:["Внутривенно 25мг-0.5мл"],
10:["Внутривенно 50мг-0.5мл"],
15:["Внутривенно 75мг-0.5мл"],
20:["Внутривенно 100мг-0.5мл"],
25:["Внутривенно 125мг-0.5мл"],
30:["Внутривенно 150мг-0.5мл"],
35:["Внутривенно 175мг-0.5мл"],
40:["Внутривенно 200мг-0.5мл"],
45:["Внутривенно 225мг-0.5мл"],
50:["Внутривенно 250мг-0.5мл"],
55:["Внутривенно 275мг-0.5мл"],
60:["Внутривенно 300мг-0.5мл"],
65:["Внутривенно 325мг-0.5мл"],
70:["Внутривенно 350мг-0.5мл"],}},
